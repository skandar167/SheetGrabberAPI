    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "1.6rem", fontWeight: 700, color: "#f8fafc", margin: 0, letterSpacing: "-0.02em" }}>SheetGrabber</h1>
          <p style={{ color: "#64748b", fontSize: "0.875rem", marginTop: "0.4rem" }}>Connectez-vous à votre espace</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
          ...
          <div>
            <label style={{ display: "block", color: "#94a3b8", fontSize: "0.8rem", marginBottom: "0.4rem", fontWeight: 500 }}>Nom d&apos;utilisateur</label>
            <input type="text" value={username} onChange={(e) => setUsername(e.target.value)}
              placeholder="skander" required autoComplete="username"
              style={{ width: "100%", padding: "0.75rem 1rem", background: "rgba(13,19,33,0.8)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "10px", color: "#f8fafc", fontSize: "0.95rem", outline: "none", fontFamily: "inherit", boxSizing: "border-box", transition: "border-color 0.2s" }}
              onFocus={(e) => (e.target.style.borderColor = "rgba(79,172,254,0.5)")}
              onBlur={(e) => (e.target.style.borderColor = "rgba(255,255,255,0.1)")}
            />
          </div>
          <div>
            <label style={{ display: "block", color: "#94a3b8", fontSize: "0.8rem", marginBottom: "0.4rem", fontWeight: 500 }}>Mot de passe</label>
        ...
        <p style={{ textAlign: "center", color: "#64748b", fontSize: "0.875rem" }}>
          ...
          <Link href="/signup" style={{ color: "#4facfe", textDecoration: "none", fontWeight: 600 }}>Créer un compte</Link>
        </p>
      </div>
    </div>
  );
